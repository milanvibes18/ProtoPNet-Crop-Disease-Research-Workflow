...
CONFIG = {
    ...
    "SAVE_DIR"              : "/kaggle/working/saves/plantwild_protopnet_v3",
    ...
    "CE_WEIGHT"             : 1.0,
    "CLUSTER_WEIGHT"        : 0.5,     # <--- Reduced 0.8 -> 0.5
    "SEPARATION_WEIGHT"     : 0.15,    # <--- Raised 0.08 -> 0.15
    "L1_WEIGHT"             : 1e-4,
    ...
    "LOG_FILE"              : "/kaggle/working/training_v3.log",
