...
CONFIG = {
    # 1. Point this to your original, raw Kaggle dataset folder
    "dataset_path": "/kaggle/input/datasets/mariaboukhelf/plantwild/plantwild/images",

    # 2. Save the text file to Kaggle's writable working directory
    "output_path": "/kaggle/working/dataset_summary.txt",
    ...
    "recursive": True, # <-- Change to True if images are inside extra sub-folders
