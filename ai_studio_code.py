# =============================================================================
# POWER-PROTOPNET — PlantWild v3 (ConvNeXt + SRM + Mixup)
# =============================================================================
...
# =============================================================================
# CONFIG - OPTIMIZED FOR 90%+ ACCURACY
# =============================================================================
CONFIG = {
    # ── Paths ──────────────────────────────────────────────────────────────────
    ...
    "SAVE_DIR"              : "./saves/plantwild_powernet",

    # ── Dataset ────────────────────────────────────────────────────────────────
    "NUM_CLASSES"           : 60,         # Adjusted to 60 as requested
    ...
    # ── Anti-Overfitting (The 90% Secret) ──────────────────────────────────────
    "ONLINE_AUG"            : True,
    "MIXUP_ALPHA"           : 0.2,       # Mixup: blends images/labels
    "CUTMIX_ALPHA"          : 1.0,       # CutMix: patches images/labels
    "DROPOUT"               : 0.3,
    "LABEL_SMOOTHING"       : 0.1,
...
class Trainer:
    ...
    def run(self):
        ...
        for ep in range(1, CONFIG["PHASE2_EPOCHS"] + 1):
            tr = self._epoch(opt2, apply_mixup=True)
